        ...
        return {
            ...
            **institutions,
            ...
            "storage": {"working_state_max_bytes": HARD_STATE_BYTES,
                        ...
                        "registered again as its next version inherits its head if it is "
                        "still kept; the next version of a program starts with no private "
                        "state, and the old version's is released at that registration. "
                        "A write that would take retained private state over "
